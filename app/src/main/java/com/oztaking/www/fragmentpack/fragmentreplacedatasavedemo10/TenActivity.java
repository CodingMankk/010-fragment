...
/**
 * @function: replace 之后对数据的保存；
 */

//class继承与FragmentActivity
public class TenActivity extends FragmentActivity implements View.OnClickListener,
    ...
    private Button mBtnReplaceFragment2;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ten_activity_layout);
        initView();
    ...
    private void initView() {
        ...
        mBtnReplaceFragment2 = (Button) findViewById(R.id.btn_replace_fragment2);
        ...
        mBtnReplaceFragment2.setOnClickListener(this);
